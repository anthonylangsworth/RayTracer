...
namespace RayTracer.Test.Samplers
{
    internal class TestNRooksSampleGenerator
    {
        ...
        public void Ctor()
        {
            ...
            NRooksSampleGenerator sampler = new NRooksSampleGenerator(random, testSamplesPerSet, testSampleSets);
        ...
        public void TestGenerateSamplesOnUnitSquare()
        {
            ...
            Random random = new Random();
            NRooksSampleGenerator sampler = new NRooksSampleGenerator(random, testSamplesPerSet, 1);
